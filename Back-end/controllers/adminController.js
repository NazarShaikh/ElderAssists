...
// Audit logs placeholder (you can connect to a real logs collection)
// Get audit logs for admin panel
// export const getAuditLogs = async (req, res) => {
//   try {
//     // Fetch all requests and populate user & helper
//     const requests = await Request.find()
//       .populate("userId", "name email role")
//       .populate("helperId", "name email role");

//     // Map requests to logs
...
//         actorRole: req.userId?.role || "user",
//         targetUser: null,
//         relatedRequest: req,
//         details: `Request created by user`,
...
//       if (req.helperId) {
//         logsArr.push({
//           _id: `${req._id}-assigned`,
//           action: "Helper Assigned",
//           performedBy: req.userId,
//           actorRole: req.userId?.role || "user",
//           targetUser: req.helperId,
//           relatedRequest: req,
//           details: `Helper assigned to request`,
...
//         logsArr.push({
//           _id: `${req._id}-completed`,
//           action: "Request Completed",
//           performedBy: req.helperId,
//           actorRole: req.helperId?.role || "helper",
//           targetUser: req.userId,
//           relatedRequest: req,
//           details: `Request marked as completed`,
//           createdAt: req.completedAt || req.updatedAt,
//         });
//       }
...
//         logsArr.push({
//           _id: `${req._id}-cancelled`,
//           action: "Request Cancelled",
//           performedBy: req.userId,
//           actorRole: req.userId?.role || "user",
//           targetUser: req.helperId || null,
//           relatedRequest: req,
